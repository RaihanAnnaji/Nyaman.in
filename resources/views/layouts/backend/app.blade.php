...
<body class="{{auth::user()->role == 'Pencari' ? 'horizontal' : 'vertical'}}-layout {{auth::user()->role == 'Pencari' ? 'horizontal' : 'vertical'}}-menu-modern 2-columns  navbar-sticky footer-static  " data-open="hover" data-menu="{{auth::user()->role == 'Pencari' ? 'horizontal' : 'vertical'}}-menu{{auth::user()->role == 'Pemilik' ? '-modern' : ''}}" data-col="2-columns" data-layout="dark-layout">

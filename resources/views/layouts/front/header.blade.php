<!-- Navbar -->
<nav class="header-navbar navbar-expand-lg navbar navbar-fixed shadow" id="targetElement">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{url('show-all-room')}}">Booking</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('show-all-room')}}">Explore</a>
                </li>
                <li class="nav-item">
            ...
            <li class="dropdown dropdown-user nav-item">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <div class="dropdown-item">
                        <p class="user-name text-bold-600">{{ Auth::user()->name }} | {{ Auth::user()->role }}</p>
                    </div>
